...
SRCS = nx_inflate.c nx_deflate.c nx_zlib.c nx_crc.c nx_dht.c nx_dht_builtin.c \
       nx_adler_combine.c gzip_vas.c nx_compress.c nx_uncompr.c
OBJS = nx_inflate.o nx_deflate.o nx_zlib.o nx_crc.o nx_dht.o nx_dht_builtin.o \
