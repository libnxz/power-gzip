...
/*
Info: dht bytes: 82 (including cpb hdr), valid bits: 4
bytes: 82 valid bits: 4
abalib@arlab081:~/project/makedht/examples$ xxd -i dht.bin
unsigned char dht_bin[] = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x02, 0x0c, 0xbd, 0xbf, 0xeb, 0x6e, 0xe3, 0xc8, 0xb6, 0x35,
  0x7f, 0xf5, 0xf7, 0xf7, 0xf7, 0xf7, 0x2b, 0xea, 0xef, 0xef, 0xef, 0xef,
  0x49, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f,
  0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f,
  0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f,
  0x7f, 0x7f, 0x82, 0xfd, 0xfd, 0xfd, 0xfd, 0x3d, 0x5a, 0x03
};
unsigned int dht_bin_len = 82;
*/

/*
unsigned char dht_bin[] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0xcc, 0x00, 0xbc, 0xeb, 0x6e, 0xe3, 0xc8, 0xb6, 0x35,
	0x7f, 0xbf, 0x92, 0xfb, 0xb4, 0x1f, 0xd2, 0x7e, 0x20, 0x67, 0x9f, 0x90,
	0x73, 0x47, 0xf6, 0xfb, 0x19, 0x03
};
unsigned int dht_bin_len = 42;
dht bytes: 42 (including cpb hdr), valid bits: 4
	   bytes: 42 valid bits: 4
*/
...
unsigned char dht_bin[] = {
	...
	// 0x00, 0x00, 
	// 0x02, 0x0c, 
  0xbd, 0xbf, 0xeb, 0x6e, 0xe3, 0xc8, 0xb6, 0x35,
  0x7f, 0xf5, 0xf7, 0xf7, 0xf7, 0xf7, 0x2b, 0xea, 0xef, 0xef, 0xef, 0xef,
  0x49, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f,
  0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f,
  0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f,
...
int dht_bin_len = 0x20c; // (82-16-1)*8+4 = 524 bits
int dht_bin_bytes = 82-16;


unsigned char dht_bin[] = {
	// 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	// 0x00, 0x00, 0x00, 0xcc, 
	0x00, 0xbc, 0xeb, 0x6e, 0xe3, 0xc8, 0xb6, 0x35,
	0x7f, 0xbf, 0x92, 0xfb, 0xb4, 0x1f, 0xd2, 0x7e, 0x20, 0x67, 0x9f, 0x90,
	0x73, 0x47, 0xf6, 0xfb, 0x19, 0x03,
};
int dht_bin_len = 0xCC;
int dht_bin_bytes = 42-16;


// bytes: 56 valid bits: 4
unsigned char dht_bin[] = {
	0xbd, 0xe3, 0x00, 0x04, 0x02, 0x08, 0xda, 0x44, 0x32, 0x32, 0xb3, 0xf7,
	0xce, 0xde, 0xca, 0x48, 0x56, 0x94, 0x3d, 0x92, 0xec, 0x95, 0x2d, 0xbb,
	0xec, 0x19, 0xd9, 0xab, 0x42, 0x84, 0xca, 0x4e, 0x43, 0xc8, 0xde, 0xca,
	0x56, 0xb2, 0xf7, 0xcc, 0x2a, 0x65, 0x45, 0x45, 0x64, 0xaf, 0x92, 0x92,
	0xf0, 0xfb, 0xff, 0x7e, 0x8f, 0xfb, 0xfd, 0x0f
};
unsigned int dht_bin_len = 56*8-4;
int dht_bin_bytes = 56;
#endif

//bytes: 70 valid bits: 6
unsigned char dht_bin[] = {
	//0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	// 0x00, 0x00, 
	0x01, 0xae, 0x00, 0xbc, 0xeb, 0x6e, 0xe3, 0xc8, 0xb6, 0x35,
	0x7f, 0x29, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd,
	0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd,
	0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd,
	0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0x09, 0x06
};
unsigned int dht_bin_len = 0x1ae;
int dht_bin_bytes = 70-16;
			       ...
			       int with_count, nx_gzip_crb_cpb_t *cmdp, void *handle)
{
	...
	/* supply the dht table */
	memcpy(cmdp->cpb.in_dht_char, dht_bin, dht_bin_bytes); 
	putnn(cmdp->cpb, in_dhtlen, dht_bin_len);
	printf("in_dhtlen %p %p = %02x %02x %02x %02x\n", 
	       &cmdp->cpb, 
	       &(cmdp->cpb.in_dhtlen),
	       (cmdp->cpb.in_dhtlen >> 24) & 0xff,
	       (cmdp->cpb.in_dhtlen >> 16) & 0xff,
	       (cmdp->cpb.in_dhtlen >> 8) & 0xff,
	       (cmdp->cpb.in_dhtlen >> 0) & 0xff);
